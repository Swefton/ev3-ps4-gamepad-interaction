...
while event:
    ...
    if ev_type == 3 and code == 0: # left stick
        right_stick_x = value
    if ev_type == 3 and code == 1: # left stick
        right_stick_y = value
    if ev_type == 3 and code == 4: # right stick
        scooper = value

    # Scale stick positions to -100,100
    forward = scale(right_stick_y, (0,255), (100,-100))
    left = scale(right_stick_x, (0,255), (100,-100))
    claw = scale(scooper, (0,255), (100,-100))
